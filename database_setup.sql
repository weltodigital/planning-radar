...
-- Run this in your Supabase SQL Editor: https://supabase.com/dashboard/project/miuvzbpijzbomvxxqvto/sql
...
-- Function to search applications near a geographic point
-- Used by the main search API for postcode radius searches
