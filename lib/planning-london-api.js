...
export function mapApplicationToDatabase(pldApp) {
  ...
  return {
    ...
    title: pldApp.proposal || pldApp.development_type || 'Planning Application',
    address: pldApp.address || null,
    postcode: pldApp.postcode || null,
    lat: pldApp.latitude ? parseFloat(pldApp.latitude) : null,
    lng: pldApp.longitude ? parseFloat(pldApp.longitude) : null,
    ...
    application_type: pldApp.application_type || pldApp.development_type || null,
    external_link: generateExternalLink(pldApp.lpa_name, pldApp.lpa_app_no),
    ward: pldApp.ward || null,
    target_decision_date: pldApp.target_decision_date ? convertDateFormat(pldApp.target_decision_date) : null
  }
}
